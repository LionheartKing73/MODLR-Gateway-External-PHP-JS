...
$server_count = 0;
$db->CommandText("SELECT droplet_id, server_user, server_password, server_type, server_ip, client_id,server_memory FROM modlr.servers WHERE NOT server_ip IS NULL  AND server_is_deleted=0;");
$db->Execute();
while( $r = $db->Rows() ) {
