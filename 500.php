...
$subject = "MODLR 500 Server Error";
$plainMessage = "MODLR 500 Server Error\r\nPlease restart the MODLR Management Database.";
$htmlMessage = "<b>MODLR 500 Server Error</b><br/>\r\nPlease restart the MODLR Management Database.";
    ...
    <div class="container ">
      ...
      <section class="error-wrapper text-center">
          ...
          <div class="error-desk">
              ...
              <p>It looks like our management database is temporarily down. Please wait a few minutes and click the link below to try again.</p>
          </div>
